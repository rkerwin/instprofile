...
class InstitutionController { 
    //this is search capability for institution

def search = {
flash.message = "Search results for: ${params.q}"
def resultsMap = Institution.search(params.q, params)
render(view:'list',
model:[
institutionInstanceList:resultsMap.results,
institutionInstanceTotal:Institution.countHits(params.q)])
}
